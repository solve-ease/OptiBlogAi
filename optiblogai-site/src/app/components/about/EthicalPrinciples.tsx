...
const principles: EthicalPrinciple[] = [
  {
    ...
    title: "Privacy First",
    description:
      "Your data belongs to you. We process content locally and never store personal information.",
    details: [
  ...
  },
  {
    ...
    description:
      "Every algorithm, decision, and process is open for inspection and improvement.",
    details: [
  ...
  },
  {
    ...
    description:
      "AI should enhance human creativity, not replace it. We build tools that empower writers.",
    details: [
  ...
  },
  {
    ...
    description:
      "Built by creators, for creators. Every feature emerges from real user needs.",
    details: [
...
const EthicalPrinciples: React.FC = () => {
  ...
  const getColorClasses = (color: string) => {
    switch (color) {
      case "primary":
        return "text-primary border-primary bg-[var(--color-primary)]/5";
      case "secondary":
        return "text-secondary border-secondary bg-[var(--color-secondary)]/5";
      case "accent":
        return "text-accent border-accent bg-[var(--color-accent)]/5";
      default:
        return "text-primary border-primary bg-[var(--color-primary)]/5";
    }
  };
  ...
  return (
    <section className="py-20 bg-gray-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <motion.div
          className="absolute top-1/4 left-1/4 w-64 h-64 bg-gradient-to-r from-[var(--color-primary)]/5 to-[var(--color-secondary)]/5 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.3, 1],
            rotate: [0, 90, 0],
          }}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            We believe AI should serve humanity with transparency, respect, and
            responsibility. These principles guide every decision we make.
          </p>
        </motion.div>
            ...
            return (
              ...
              >
                <Card
                  ...
                  onClick={() =>
                    setSelectedPrinciple(isSelected ? null : principle.id)
                  }
                >
                          ...
                          {isSelected && (
                            ...
                            >
                              {principle.details.map((detail, detailIndex) => (
                                ...
                                >
                                  <CheckCircle
                                    className={`w-5 h-5 mt-0.5 text-${principle.color} flex-shrink-0`}
                                  />
          ...
          <Card className="max-w-4xl mx-auto bg-gradient-to-r from-[var(--color-primary)]/5 to-[var(--color-secondary)]/5 border-0">
            <CardContent className="p-8">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                ...
                foundation of everything we build. Every line of code, every
                feature, and every decision is measured against these
                principles. We&apos;re not perfect, but we&apos;re committed to
