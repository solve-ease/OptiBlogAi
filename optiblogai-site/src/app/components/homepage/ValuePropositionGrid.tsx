  ...
  const valueProps: ValueProp[] = [
    {
      ...
      description:
        "Create optimized blog content in seconds with our advanced AI algorithms",
      features: [
    ...
    },
    {
      ...
      description:
        "Join a thriving community of developers and content creators",
    ...
    },
    {
      ...
      title: "Privacy First",
      description:
        "Your data stays secure with local processing and ethical AI practices",
      features: [
        "Local processing",
        "No data collection",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover the powerful features that make OptiBlogAi the perfect
            choice for modern content creators
          </p>
        </div>
          ...
          {valueProps.map((prop, index) => (
            ...
            >
              <CardContent className="p-8">
                <div
                  className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-6 ${prop.color} group-hover:scale-110 transition-transform duration-300`}
                >
                  {prop.icon}
                </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-[var(--color-primary)] to-[var(--color-secondary)] rounded-2xl p-8 text-white">
            ...
            <p className="text-lg mb-6 opacity-90">
              Join thousands of content creators who trust OptiBlogAi for their
              optimization needs
            </p>
