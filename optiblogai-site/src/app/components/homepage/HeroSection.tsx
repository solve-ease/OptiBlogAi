  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-50 via-white to-gray-100">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-accent/3 rounded-full blur-3xl animate-float"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-slide-up">
          ...
          <p className="text-xl sm:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            Create, optimize, and scale your content strategy with our
            open-source AI platform. Built by developers, for developers.
          </p>
        ...
        <div className="animate-slide-up" style={{ animationDelay: "0.2s" }}>
          <div className="relative max-w-5xl mx-auto">
            ...
            ></div>
            <div
              className="absolute top-1/2 -left-6 w-4 h-4 bg-accent rounded-full animate-float"
              style={{ animationDelay: "2s" }}
            ></div>
          </div>
        </div>
