...
const TeamCollaborationPreview: React.FC = () => {
  ...
  const permissions = [
    ...
    {
      role: "Manager",
      permissions: ["Read", "Write", "Comment", "Approve", "Admin"],
      color: "bg-pink-400",
    },
  ];
    ...
    const timer4 = setTimeout(() => {
      setComments([
        ...
        },
        {
          id: 2,
          user: "Mike Johnson",
          text: "Should we add more examples?",
          time: "2m",
          avatar: "MJ",
        },
      ]);
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="text-sm text-gray-800">
                  ...
                  <span className="font-medium">
                    {activities[currentActivity].target}
                  </span>
                </div>
